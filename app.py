"""EmiTech Store — Proyecto Integrador, Semana 9.

Cinco rutas de Flask y plantillas Jinja2. Los datos son demostrativos:
no hay conexión a una base de datos ni almacenamiento de información.
"""
...
def inicio():
    ...
    return render_template("index.html", catalogo=obtener_catalogo())
...
def productos():
    ...
    lista_productos = [
        ...
        {"codigo": "PRO-006", "nombre": "Disco SSD de 480 GB", "categoria": "Componentes informáticos", "descripcion": "Unidad SATA para mejorar el almacenamiento del equipo.", "precio": "45.00", "stock": 10, "imagen": "disco-ssd.jpg"},
    ]
...
def facturacion():
    ...
    return render_template("facturacion.html", factura=factura, detalle=detalle)
